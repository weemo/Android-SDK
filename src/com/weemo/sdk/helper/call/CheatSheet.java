...
public class CheatSheet {
     ...
     *
     * @param button The view to add a cheat sheet for.
     */
     ...
     */
    public static void setup(View button, final int textResId) {
        button.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
     ...
     */
    public static void setup(View button, final CharSequence text) {
        button.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
     ...
     *
     * @param view The view whose cheat sheet should be displayed.
     * @param text The text to display
     * @return true if the toast has been displayed
     */
    protected static boolean showCheatSheet(View view, CharSequence text) {
